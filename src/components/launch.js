      ...
      >
        ...
        <GridItem pl='2' area={'main'} className="main">
          ...
          <Flex className="main-content">
            ...
            <Text className="main-heading">Step into the Future of Security Technology!</Text>
            <Text className="main-subheading">Join us for an exciting four-day showcase of groundbreaking security technology at Promatec’s Launch Event. Get hands-on experience with state-of-the-art security technology, live demonstrations, and gain insights from industry leaders.</Text>
            <Text className="main-subheading blue">12<sup>th</sup>-15<sup>th</sup> February |  8AM-5PM  |  32 Knightsbridge, Newlands, Harare.</Text>
